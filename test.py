...
nn.add_layer(Layer(2, 50, 'sigmoid'))
nn.add_layer(Layer(50, 100, 'sigmoid'))
nn.add_layer(Layer(100, 80, 'sigmoid'))
nn.add_layer(Layer(80, 40, 'sigmoid'))
nn.add_layer(Layer(40, 10, 'sigmoid'))
nn.add_layer(Layer(10, 2, 'sigmoid'))

# print(X_train)
# 训练
Mses = nn.train(x_train, x_test, y_train, y_test, 0.8, 1000)
print(Mses)
Result = nn.predict(x_test, y_test)
print(Result)
